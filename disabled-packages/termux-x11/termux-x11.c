...
# define TERMUX_PREFIX "/data/data/dev.mutwakil.androidide/files/usr"
#endif

#ifndef TERMUX_X11_DIR
# define TERMUX_X11_DIR "/data/data/dev.mutwakil.androidide.x11/"
#endif
...
int main(int argc, char *argv[]) {
	...
	char *server_argv[] = {TERMUX_PREFIX "/bin/am", "start", "-n", "dev.mutwakil.androidide.x11/.MainActivity", NULL};
