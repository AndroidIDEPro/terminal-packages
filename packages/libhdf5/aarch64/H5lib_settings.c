...
const char H5libhdf5_settings[]=
	...
	"             Installation point: /data/data/dev.mutwakil.androidide/files/usr\n"
	"\n"
	"Compiling Options:\n"
	"------------------\n"
	"                     Build Mode: Release\n"
	...
	"                        LDFLAGS: -Wl,--as-needed -L/data/data/dev.mutwakil.androidide/files/usr/lib\n"
	"                     H5_LDFLAGS: \n"
	"                     AM_LDFLAGS: \n"
	"                Extra libraries: m;dl\n"
	"                       Archiver: /data/data/dev.mutwakil.androidide/files/usr/bin/ar\n"
	"                         Ranlib: /data/data/dev.mutwakil.androidide/files/usr/bin/ranlib\n"
	"\n"
	"Languages:\n"
	"----------\n"
	"                              C: YES\n"
	"                     C Compiler: /data/data/dev.mutwakil.androidide/files/usr/bin/clang 15.0.7\n"
	"                       CPPFLAGS: \n"
	"                    H5_CPPFLAGS: \n"
	"                    AM_CPPFLAGS: \n"
	"                         CFLAGS:  -std=c99 -Oz -fstack-protector-strong -I/data/data/dev.mutwakil.androidide/files/usr/include\n"
	...
	"               Module Directory: /data/data/dev.mutwakil.androidide/files/files/home/termux.libhdf5.build/mod\n"
	"\n"
	"                            C++: ON\n"
	"                   C++ Compiler: /data/data/dev.mutwakil.androidide/files/usr/bin/clang++ 15.0.7\n"
	"                      C++ Flags:  -Oz -fstack-protector-strong -I/data/data/dev.mutwakil.androidide/files/usr/include\n"
